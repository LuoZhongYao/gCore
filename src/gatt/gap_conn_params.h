...
#define FAST_CONNECTION_ADVERT_TIMEOUT_VALUE  TIMER_INVALID
...
#define SLOW_CONNECTION_ADVERT_TIMEOUT_VALUE  (60 * SECOND)
...
/* Minimum and maximum connection interval in number of frames. */
#define APPLE_MAX_CON_INTERVAL                0x0020 /* 40 ms */
#define APPLE_MIN_CON_INTERVAL                0x0010 /* 20 ms */
